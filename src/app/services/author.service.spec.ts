    ...
    it('should call get with the correct url', () => {
      ...
      req.flush([
        ...
        },
        {
          ...
          about: "Robin Patricia Williams is an American educator who has authored many popular computer-related books, as well as the book Sweet Swan of Avon: Did a Woman Write Shakespeare?.",
          version: "AAAAAAAAB9Q=",
          books: [
            {
